# Linki do podmiany na WordPress – Imprezja Quiz 1.2.1

## Release na GitHub
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/tag/v1.2.1
...
### Windows
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.1/Imprezja.Quiz.Setup.1.2.1.exe
```

### macOS Apple Silicon (M1/M2/M3)
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.1/Imprezja.Quiz-1.2.1-arm64.dmg
```

### macOS Intel
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.1/Imprezja.Quiz-1.2.1.dmg
```
...
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.1/napraw-uninstaller.bat
```
...
4. **Blok pobierz** – `docs/wordpress/09-pobierz-1.2.1.html`
...
Wersja 1.2.1 zawiera m.in.: Admin PWA (zwijane menu, mikser), WiFi Analyzer (20/40 MHz), wizualizacje (beat 80–150 BPM, Milkdrop 30 fps).
