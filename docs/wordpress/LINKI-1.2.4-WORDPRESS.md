# Linki do podmiany na WordPress – Imprezja Quiz 1.2.4

## Jeśli pobieranie z GitHub daje „Not Found" (404)

Adresy `…/releases/download/v1.2.4/…` są **poprawne**, o ile plik **faktycznie został wgrany** do tego release'u. Po przerwanym `publish:github` na GitHubie może zostać np. tylko `.exe`, a **`.dmg` zwrócą 404** — linki na stronie wtedy „nie działają", choć sama ścieżka jest dobra.
...
## Release na GitHub
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/tag/v1.2.4
...
### Windows
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.4/Imprezja.Quiz.Setup.1.2.4.exe
```

### macOS Apple Silicon (M1/M2/M3)
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.4/Imprezja.Quiz-1.2.4-arm64.dmg
```

### macOS Intel
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.4/Imprezja.Quiz-1.2.4.dmg
```
...
```
https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/download/v1.2.4/napraw-uninstaller.bat
```
...
4. **Blok pobierz** – `docs/wordpress/09-pobierz-1.2.4.html`
...
## Co nowego w 1.2.4 (krótko – do opisu na WordPress)

**Sklep Stripe / licencje**
- Po opłaceniu odnowienia subskrypcji w Stripe program dostaje **nowy klucz** e-mailem (`invoice.paid`).
- Zapis **Machine ID** w metadanych Stripe po odebraniu klucza z aplikacji.
- Idempotencja webhooka (brak podwójnej wysyłki przy retry).
- Komunikat e-mail, gdy brakuje Machine ID w zamówieniu.

**Uwaga dla klientów:** identyfikator komputera (Machine ID) jest **inny na Windows i na macOS** — klucz musi być zamówiony dla systemu, na którym działa aplikacja.

Pełny changelog: `CHANGELOG.md` oraz https://github.com/djdamsza/Imprezja-Quiz-1.0.2-beta/releases/tag/v1.2.4
